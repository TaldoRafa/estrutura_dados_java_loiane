...
public class Ex03 {
    public static void main(String[] args) {
        ...
        System.out.println("Desenpilhando livros da pilha: ");

        while (!pilha.estaVazia()) {
            System.out.println("Desenpilhando livro: " + pilha.desempilha());
        }

        System.out.println("Todos os livros foram desenpilhados, pilha vazia. " + pilha.estaVazia());
    }
}
